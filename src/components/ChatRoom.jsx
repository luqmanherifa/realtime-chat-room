        ...
        <div className="flex-1 min-h-0 overflow-y-auto">
          ...
          <div className="px-4 py-4 pb-6">
            <div className="sticky top-20 z-10 mb-4 flex justify-end">
              <div className="w-[80%] bg-blue-500 text-white rounded-2xl rounded-tr-sm px-4 py-3">
                <div className="flex items-center justify-between mb-2">
                  <p className="text-[10px] opacity-80">Anda</p>
                  <button
                    type="button"
                    ...
                    className={`
                      ...
                      ${
                        myMessage
                          ? "bg-blue-400 bg-opacity-50 text-white hover:bg-opacity-70 active:scale-95"
                          : "bg-blue-400 bg-opacity-20 text-blue-200 cursor-not-allowed"
                      }
                    `}
                    title="Reset teks"
                  >
                ...
                <textarea
                  ...
                  placeholder="Ketik sesuatu di sini... (Enter untuk hapus)"
                  rows={2}
                  className="w-full resize-none bg-blue-400 bg-opacity-30 text-white placeholder-blue-100 rounded-lg px-3 py-2 text-sm focus:outline-none focus:bg-opacity-40"
                />
              </div>
            </div>
