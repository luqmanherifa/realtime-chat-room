    ...
    <main className="h-screen w-full flex justify-center bg-white">
      <div className="w-full max-w-md h-screen flex flex-col">
        <div className="flex-1 min-h-0 overflow-y-auto">
          {/* Header */}
          <div className="sticky top-0 h-24 px-6 flex items-center justify-between border-b-2 border-gray-200 bg-white z-20">
            ...
            <div className="sticky top-24 z-10 mb-6 flex justify-end">
              <div className="w-[85%] bg-whisper text-white rounded-2xl rounded-tr-md px-5 py-4">
                ...
                <textarea
                  ...
                  placeholder="Tulis pesan Anda di sini... (tekan Enter untuk menghapus)"
                  rows={3}
                  className="w-full resize-none bg-white bg-opacity-20 text-white placeholder-purple-100 rounded-xl px-4 py-3 text-base font-medium focus:outline-none focus:bg-opacity-30 transition"
                />
              </div>
            </div>
