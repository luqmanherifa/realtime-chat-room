...
import { BackIcon, SmileIcon } from "./icons";
      ...
      <div className="w-full max-w-md h-full flex flex-col px-5 py-6">
        ...
        <div className="flex flex-col gap-6 flex-1">
          ...
          >
            ...
            <input
              className="w-full h-12 rounded-xl border-2 border-slate-200 bg-white px-4 text-sm font-medium text-slate-800 placeholder:text-slate-400 focus:outline-none focus:border-echo transition-colors"
              type="text"
              value={roomCode}
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          onClick={onSubmit}
          className="h-14 rounded-2xl bg-echo text-sm font-bold uppercase tracking-wide text-white flex items-center justify-center gap-2.5"
        >
